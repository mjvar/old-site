window.onload = function() {
    ...
    src(o2).modulate(src(o1).add(solid(1,1),-0.5),()=>p5.map(p5.mouseX,0,p5.width,0.0,-.008)).blend(src(o0),()=>p5.map(p5.mouseX,0,p5.width,.4,-0.01)).out(o2)

    src(o0).blend(o2,()=>Math.pow(p5.mouseX/p5.width,.5)).out(o3)
